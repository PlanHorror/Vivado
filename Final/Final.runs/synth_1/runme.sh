...
HD_PWD='F:/Repository/Vivado/Final/Final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Encoding.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Encoding.tcl
