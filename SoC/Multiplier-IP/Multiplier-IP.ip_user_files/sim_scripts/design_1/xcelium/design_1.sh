...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../bd/design_1/ipshared/4b70" \
       +incdir+"$ref_dir/../../../../Multiplier-IP.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../Multiplier-IP.gen/sources_1/bd/design_1/ipshared/abef/hdl" \
       +incdir+"../../../../Multiplier-IP.gen/sources_1/bd/design_1/ipshared/4b70" \
       +incdir+"../../../../Multiplier-IP.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../Multiplier-IP.gen/sources_1/bd/design_1/ipshared/abef/hdl" \
