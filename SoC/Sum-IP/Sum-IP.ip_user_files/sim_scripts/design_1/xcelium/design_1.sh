...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../Sum-IP.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../Sum-IP.gen/sources_1/bd/design_1/ipshared/abef/hdl" \
       +incdir+"$ref_dir/../../../bd/design_1/ipshared/5082/sum.srcs/sources_1/new" \
       +incdir+"../../../../Sum-IP.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../Sum-IP.gen/sources_1/bd/design_1/ipshared/abef/hdl" \
       +incdir+"../../../../Sum-IP.gen/sources_1/bd/design_1/ipshared/5082/sum.srcs/sources_1/new" \
